...
module: infra/hosting
tags: [deployment, docker, ci-cd, infrastructure, containers]
---
...
- [security-review](security-review.md) -- infrastructure security checklist, secrets management
- [logging-standards](logging-standards.md) -- structured logging patterns for production
