...
scope: universal
profile: all
tags: [terminal, python, shell, execution]
---
...
- [cli-conventions](cli-conventions.md) — CLI tool design patterns
- [logging-standards](logging-standards.md) — Output and logging conventions
