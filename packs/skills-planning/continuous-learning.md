...
module: docs/friction
tags: [learning, instincts, patterns, improvement]
---
...
- [post-work-update](post-work-update.md) — Triggers learning capture at end of work
- [skill-creator](skill-creator.md) — How to create new skills when patterns are extracted
- [request-skill](request-skill.md) — How to identify when a new skill is needed
