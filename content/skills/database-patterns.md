...
tags: [database, sql, migrations, repository, queries]
---
...
- [api-design](api-design.md) -- API endpoints that consume these data access patterns
- [security-review](security-review.md) -- SQL injection checks and data protection review
