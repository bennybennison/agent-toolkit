...
module: connector/full, connector/lite
...
- [api-design](api-design.md) — REST API design patterns (for the APIs you consume)
- [security-review](security-review.md) — Security considerations for API integrations
- [dependency-management](dependency-management.md) — Managing API client libraries
