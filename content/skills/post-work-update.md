...
tags: [governance, documentation, maintenance]
---
...
- [spec-lifecycle](spec-lifecycle.md) — Spec state transitions and format
- [document-ownership](document-ownership.md) — Which docs to update when
- [continuous-learning](continuous-learning.md) — How to capture and promote learnings
