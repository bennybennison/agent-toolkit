---
name: "spec-lifecycle"
description: "Manage specifications through a structured hierarchy and lifecycle — from epic vision to actionable tasks."
...
- [review-specs](../review-specs/SKILL.md) — Deduplication and cross-referencing workflow
- [document-ownership](../document-ownership/SKILL.md) — Which docs to update when
- [blueprint](../blueprint/SKILL.md) — Creating technical plans
- [post-work-update](../post-work-update/SKILL.md) — Checklist for updating docs after work
