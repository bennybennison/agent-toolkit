...
description: "A systematic process for finding and fixing bugs. This skill is about the mental discipline of debugging -- not specific tools, but the approach that makes any tool effective."
pack: "skills-core"
---
...
- [verification-loop](../verification-loop/SKILL.md) -- pre-commit checks to catch bugs before they ship
- [tdd-workflow](../tdd-workflow/SKILL.md) -- writing regression tests as part of bug fixes
- [git-commit-discipline](../git-commit-discipline/SKILL.md) -- History Archaeologist mode for tracing regressions
