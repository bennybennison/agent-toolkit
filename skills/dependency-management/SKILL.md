...
description: "When and how to manage third-party dependencies. Every dependency is a liability -- it adds attack surface, maintenance burden, and coupling to external maintainers. This skill provides a decision framework and operational workflow using `uv` as the package manager."
pack: "skills-python"
---
...
- [security-review](../security-review/SKILL.md) -- includes dependency vulnerability scanning as part of broader security review
