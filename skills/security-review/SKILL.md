...
description: "Structured security review process based on OWASP Top 10. Run this before merging any change that touches trust boundaries."
pack: "skills-ops"
---
...
- [multi-perspective-analysis](../multi-perspective-analysis/SKILL.md) -- use security as one perspective in broader reviews
