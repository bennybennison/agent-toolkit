---
name: "python-testing"
description: "Pytest-specific patterns and tooling for Python projects. This skill complements [tdd-workflow](../tdd-workflow/SKILL.md) (which covers methodology) with concrete implementation guidance."
pack: "skills-python"
---

# Skill: Python Testing

Pytest-specific patterns and tooling for Python projects. This skill complements [tdd-workflow](../tdd-workflow/SKILL.md) (which covers methodology) with concrete implementation guidance.
...
**See also:**
- [tdd-workflow](../tdd-workflow/SKILL.md) -- the RED/GREEN/REFACTOR methodology
- [eval-driven-development](../eval-driven-development/SKILL.md) -- testing agent behaviour (not application code)
