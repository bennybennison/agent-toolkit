...
description: "When and how to use `asyncio`, threading, and multiprocessing in Python. The wrong concurrency model for the workload type will either waste resources or provide no speedup at all."
pack: "skills-python"
---
...
- [python-testing](../python-testing/SKILL.md) -- patterns for testing async code with `pytest-asyncio`
- [debugging-methodology](../debugging-methodology/SKILL.md) -- debugging concurrent race conditions and deadlocks
