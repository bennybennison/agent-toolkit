...
Use this recipe when the request is still conceptual and implementation should not begin until the approach, boundaries, and success conditions are clear.

The recipe should produce:

- a concrete plan
- assumptions and open questions
- a handoff bundle that later implementation can consume
